...
public class DFARuleBookTest {
    ...
    public void setUp() throws Exception {
        ruleBook = new DFARuleBook(Arrays.asList(new FARule("1", 'a', "2"), new FARule("1", 'b', "1"), new FARule("2", 'a', "2"), new FARule("2", 'b', "3"), new FARule("3", 'a', "3"), new FARule("3", 'b', "3")));
    }
    ...
    public void test1() throws Exception {
        ...
        DFARuleBook ruleBook = new DFARuleBook(Arrays.asList(new FARule("1", 'a', "2"), new FARule("1", 'b', "1"), new FARule("2", 'a', "2"), new FARule("2", 'b', "3"), new FARule("3", 'a', "3"), new FARule("3", 'b', "3")));
