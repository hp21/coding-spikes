...
import org.hp.jaxb.Items;
import org.hp.jaxb.ObjectFactory;
import org.hp.jaxb.PurchaseOrderType;
import org.hp.jaxb.USAddress;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        itemList.add(createItem("Godzilla and Mothra: Battle for Earth/Godzilla vs. King Ghidora", 3, new BigDecimal("27.95"), null, null,
                "242-GZ"));
    ...
    public static Items.Item createItem(String productName, int quantity, BigDecimal price, String comment, XMLGregorianCalendar shipDate,
            String partNum) {
